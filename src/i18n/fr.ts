export const fr: Record<string, string> = {
  ...
  'quiz.remediate': "M'entraîner sur mes erreurs",
  ...
  'fillBlank.spellingAlert': "Attention à l'orthographe : on écrit « {answer} ».",
  ...
  'toast.projectDeleteError': 'Erreur lors de la suppression du projet',
  'toast.projectLoadError': 'Erreur lors du chargement du projet',
  ...
  'toast.remediationSummaryError': "La fiche de rappel n'a pas pu être générée",
  ...
  'profile.readingComfort': 'Confort de lecture',
  'profile.readingFont': 'Police de lecture',
  'profile.fontDefault': 'Standard',
  'profile.fontLuciole': 'Luciole (basse vision)',
  'profile.letterSpacing': 'Espacement des lettres',
  'profile.wordSpacing': 'Espacement des mots',
  'profile.lineSpacing': 'Interligne',
  'profile.lucioleCredit': 'Police Luciole © Laurent Bourcellier & Jonathan Perez — CC BY 4.0',
  ...
  'apiKey.title': 'Clé API Mistral',
  'apiKey.info': 'Saisis ta clé Mistral. Elle reste dans ce navigateur, jamais sur le serveur.',
  'apiKey.label': 'Clé API Mistral',
  'apiKey.placeholder': 'Colle ta clé Mistral ici',
  'apiKey.scopeGlobal': 'Globale',
  'apiKey.scopeProfile': 'Ce profil',
  'apiKey.test': 'Tester',
  'apiKey.degradedWarn': 'Connexion non sécurisée : la clé sera stockée en clair sur cet appareil.',
  'apiKey.degradedConsent': 'Je comprends, stocker la clé en clair sur cet appareil',
  'apiKey.settingsTitle': 'Clé API Mistral',
  'apiKey.configured': 'Clé configurée ✓',
  'apiKey.notConfigured': 'Aucune clé configurée',
  'apiKey.configure': 'Configurer',
  'apiKey.change': 'Modifier',
  'apiKey.clearGlobal': 'Supprimer la clé globale',
  'apiKey.status.ok': 'Clé valide ✓',
  'apiKey.status.invalid': 'Clé invalide',
  'apiKey.status.quota': 'Quota dépassé',
  'apiKey.status.network': 'Erreur réseau',
  'apiKey.status.missing': 'Aucune clé saisie',
  'apiKey.status.testing': 'Test en cours…',
  'toast.keySaved': 'Clé enregistrée',
  'toast.keyCleared': 'Clé supprimée',
};

export const en: Record<string, string> = {
  ...
  'gen.costPrefix': 'Est.',
  'cost.audio': 'Audio',
  'cost.route': 'Auto routing',
  'cost.batch': 'Auto generation',
  'cost.moderation': 'Moderation',
  'cost.consigne': 'Instructions detection',
  'cost.vocalAnswer': 'Voice answer',
  ...
  'gen.needsTts': "Sound isn't on — ask an adult to turn it on in Settings",
  ...
  'settings.resetConfirm':
    'Reset all settings to default? The chosen models and preferences will be replaced.',
  ...
  'settings.ocr': 'OCR',
  'settings.tts': 'TTS',
  'settings.perMTokens': 'per M tokens (in/out)',
  'settings.perKPages': 'per 1000 pages',
  'settings.perMChars': 'per M chars',
  'settings.priceUnknown': 'price unavailable',
  'settings.ocrHint': 'OCR 3: economical. OCR 4: better quality, 2× cost.',
  ...
  'sources.fileStatus.hashing': 'Checking…',
  'sources.fileStatus.duplicate': 'Already imported',
  'sources.importAnyway': 'Import anyway',
  'sources.ignore': 'Ignore',
  'sources.duplicateWarning': '{n} file(s) already in the project',
  ...
  'summary.simplify': 'Very easy-to-read version',
  ...
  'quiz.remediate': 'Practice my mistakes',
  ...
  'podcast.noTts': "Sound isn't on yet. Ask an adult to turn it on in Settings!",
  ...
  'toast.audioQuotaExceeded': 'Audio quota reached — try again a bit later',
  ...
  'toast.cancelFailed': 'Failed to cancel {type}',
  'toast.confirmActionFailed': "It didn't work. Try again!",
  'toast.scoreSaved': 'Score saved!',
  'toast.scoreError': 'Score save error',
  'toast.remediationGenerated': 'Recap sheet and practice quiz ready!',
  'toast.remediationSummaryError': 'The recap sheet could not be generated',
  ...
  'profile.parentSection': 'Parent area',
  'profile.parentSectionHint': 'Moderation, AI chat and categories — protected by the parent code',
  ...
  'profile.readingComfort': 'Reading comfort',
  'profile.readingFont': 'Reading font',
  'profile.fontDefault': 'Default',
  'profile.fontLuciole': 'Luciole (low vision)',
  'profile.letterSpacing': 'Letter spacing',
  'profile.wordSpacing': 'Word spacing',
  'profile.lineSpacing': 'Line spacing',
  'profile.lucioleCredit': 'Luciole font © Laurent Bourcellier & Jonathan Perez — CC BY 4.0',
  ...
  'apiKey.title': 'Mistral API Key',
  'apiKey.info': 'Enter your Mistral key. It stays in this browser, never on the server.',
  'apiKey.label': 'Mistral API Key',
  'apiKey.placeholder': 'Paste your Mistral key here',
  'apiKey.scopeGlobal': 'Global',
  'apiKey.scopeProfile': 'This profile',
  'apiKey.test': 'Test',
  'apiKey.degradedWarn':
    'Insecure connection: the key will be stored in clear text on this device.',
  'apiKey.degradedConsent': 'I understand, store the key in clear text on this device',
  'apiKey.settingsTitle': 'Mistral API Key',
  'apiKey.configured': 'Key configured ✓',
  'apiKey.notConfigured': 'No key configured',
  'apiKey.configure': 'Configure',
  'apiKey.change': 'Change',
  'apiKey.clearGlobal': 'Remove global key',
  'apiKey.status.ok': 'Valid key ✓',
  'apiKey.status.invalid': 'Invalid key',
  'apiKey.status.quota': 'Quota exceeded',
  'apiKey.status.network': 'Network error',
  'apiKey.status.missing': 'No key entered',
  'apiKey.status.testing': 'Testing…',
  'toast.keySaved': 'Key saved',
  'toast.keyCleared': 'Key removed',
};

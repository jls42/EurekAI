...
**EurekAI** nació durante el [Mistral AI Worldwide Hackathon](https://luma.com/mistralhack-online) ([sitio oficial](https://worldwide-hackathon.mistral.ai/)) (marzo de 2026). Necesitaba un tema — y la idea vino de algo muy concreto: preparo regularmente las pruebas con mi hija, y pensé que debía ser posible hacer eso más lúdico e interactivo gracias a la IA.
...
|---|---|---|
| 📷 | **Subida OCR** | Haz una foto de tu manual o tus apuntes — Mistral OCR extrae el contenido |
| 📝 | **Entrada de texto** | Escribe o pega cualquier texto directamente |
| 🎤 | **Entrada de voz** | Graba tu voz — Voxtral STT transcribe tu audio |
...
| 🃏 | **Flashcards** | 5-50 tarjetas Q/A con referencias a las fuentes para memorización activa |
| ❓ | **Quiz de opción múltiple** | 5-50 preguntas de opción múltiple con revisión adaptativa de errores |
| ✏️ | **Textos con huecos** | Ejercicios para completar con pistas y validación tolerante |
| 🎙️ | **Podcast** | Mini-podcast de 2 voces convertido en audio vía Mistral Voxtral TTS |
...
| 🧠 | **Router inteligente** | La IA analiza tu contenido y recomienda los generadores más pertinentes entre los 7 disponibles |
...
| **Flashcards** | `mistral-large-latest` | 5-50 tarjetas Q/A con referencias a las fuentes para memorización activa |
| **Quiz de opción múltiple** | `mistral-large-latest` | 5-50 preguntas, 4 opciones cada una, explicaciones, revisión adaptativa |
...
El enrutador usa `mistral-small-latest` para analizar el contenido de las fuentes y recomendar qué generadores son más pertinentes entre los 7 disponibles — para que los alumnos no tengan que elegir manualmente. La interfaz muestra el progreso en tiempo real: primero una fase de análisis, luego las generaciones individuales con posibilidad de cancelación.
...
- **Detección de instrucciones**: detecta las consignas de repaso ("Sé mi lección si sé...") y las prioriza en todos los generadores
...
- Prompts IA soportan 2 idiomas hoy (FR, EN) con arquitectura preparada para 15 (es, de, it, pt, nl, ja, zh, ko, ar, hi, pl, ro, sv)
...
| **Servidor de desarrollo** | Vite 7.3 + tsx | HMR, partials Handlebars, proxy |
...
| `DELETE` | `/api/profiles/:id` | Eliminar un perfil + proyectos en cascada |
...
| `POST` | `/api/projects/:pid/moderate` | Modificar `{text}` |
...
| **Vite + Handlebars** | Lo mejor de ambos mundos: HMR rápido para desarrollo, partials HTML para organizar el código, Tailwind JIT. |
...
Construido con esmero durante el Mistral AI Worldwide Hackathon, marzo de 2026.

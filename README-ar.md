...
**EurekAI** وُلد أثناء [Mistral AI Worldwide Hackathon](https://worldwide-hackathon.mistral.ai/) (مارس 2026). كنت بحاجة لموضوع — والفكرة جاءت من شيء عملي جدًا: أنا أُعدُّ الاختبارات بانتظام مع ابنتي، وفكرت أنه من الممكن جعل ذلك أكثر متعة وتفاعلية بفضل الذكاء الاصطناعي.

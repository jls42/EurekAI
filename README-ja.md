...
**EurekAI** は [Mistral AI Worldwide Hackathon](https://worldwide-hackathon.mistral.ai/)（2026年3月）で誕生しました。テーマが必要で、着想はごく身近なところから来ました：娘のテスト準備をよく手伝っていて、AIを使えばもっと楽しくインタラクティブにできるはずだと考えたのです。
